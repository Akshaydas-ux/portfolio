...
0%{
box-shadow:0 0 0 0 rgba(50,215,75,.7);
}
...
.project-card:not(.video-card)::before{
...
.project-card:not(.video-card):hover::before{
...
.contact-form button:hover{
    ...
    box-shadow:0 10px 25px rgba(255,111,97,.3);
}
